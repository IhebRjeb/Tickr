...
| 5   | Gateway                     | _external_                        | Static placeholder — not a real integration                                                                                                                                                                                                                                                                                                                                                         |
...
behaviour is the _absence_ of a retry).
...
| Authenticated shared | 10                        | `U-01`…`U-09`, `S-01` | ☐     | ☐                   | ☐        |
| Organizer            | 8                         | `O-01`…`O-08`         | ☐     | ☐                   | ☐        |
| Admin                | 4                         | `A-01`…`A-04`         | ☐     | ☐                   | ☐        |
| **Total**            | **33 (+3)**               | **33 IDs**            | ☐     | ☐                   | ☐        |
